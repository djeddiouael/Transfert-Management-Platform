...
@section('content')
    <div id="admin-content">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h2 class="admin-heading">جميع التسجيلات الأولية</h2>
                </div>
                <div class="offset-md-6 col-md-2">
                    <a class="add-new" href="{{ route('student.create') }}">إضافة تسجيل</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="content-table">
                        ...
                        <tbody>
                            @forelse ($students as $student)
                                <tr>
                                    <td class="id">{{ $student->matricule }}</td>
                                    <td>{{ $student->name }}</td>
                                    ...
                                    <td class="edit">
                                        <a href="{{ route('student.edit', $student) }}" class="btn btn-warning">تعديل</a>
                                    </td>
                                    <td class="delete">
                                        <form action="{{ route('student.destroy', $student->id) }}" method="post"
                                            class="form-hidden">
                                            <button class="btn btn-danger delete-student">حذف</button>
                                            @csrf
                                        </form>
                                    </td>
                                </tr>
